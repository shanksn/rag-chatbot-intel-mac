...
class VectorStore:
    ...
    def __init__(self, chroma_path: str, embedding_model: str, max_results: int = 5):
        ...
        # Use ChromaDB's default local embedding function (no external APIs)
        # This uses a lightweight local model that doesn't require PyTorch
